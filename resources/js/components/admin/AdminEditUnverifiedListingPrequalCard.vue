...
// raw 11-digit local form (09XXXXXXXXX) the admin is typing into the
// contact card, the 10-digit no-leading-zero form (9XXXXXXXXX), and the
// E.164 forms (+639XXXXXXXXX / 639XXXXXXXXX) that come back from the
// server after normalization.
const formattedContactPhone = computed(() => {
    const phone = form.contact?.phone || null;
