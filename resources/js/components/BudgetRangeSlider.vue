                ...
                >
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input
                                    ...
                                    class="w-full bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 rounded-lg px-3 pr-14 py-2 text-sm outline-none tabular-nums"
                                >
                    ...
                    <div class="px-5 pt-5 pb-5 flex items-center justify-between gap-3">
                        ...
                        <button
                            type="button"
                            @click="closePanel"
                            class="px-5 py-2 rounded-lg bg-orange-500 hover:bg-orange-600 active:bg-orange-700 text-white text-sm font-semibold transition-colors cursor-pointer min-h-[44px]"
                        >
                            Done
                        </button>
                    </div>
